 ...
 * @public
 */
export function provideAnalytics(config) {
 ...
 * @public
 */
export function provideSearchAnalytics(config) {
    var httpRequester = new HttpRequester();
 ...
 * @public
 */
export function providePagesAnalytics(config) {
    var httpRequester = new HttpRequester();
 ...
 * @public
 */
export function provideConversionTrackingAnalytics(debug) {
    var httpRequester = new HttpRequester();
 ...
 * @public
 */
export function provideChatAnalytics(config) {
    var httpRequester = new HttpRequester();
