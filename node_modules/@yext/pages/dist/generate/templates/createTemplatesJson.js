...
const createTemplatesJson = async (templateFilepaths, redirectFilepaths, projectStructure, type) => {
...
const createTemplatesJsonFromModule = async (templateModules, redirectModules, projectStructure, type) => {
...
const getTemplatesConfig = (templateModules, redirectModules) => {
  const features = [];
  const streams = [];
