...
const artifactsCommand = (program) => {
  program.command("artifacts").description("Generatesartifacts.json file").option("--scope <string>", "The subfolder to scope from").action(artifactsHandler);
};
export {
  artifactsCommand,
  artifactsHandler
