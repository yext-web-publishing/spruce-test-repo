import { Manifest, ServerRenderTemplate, TemplateProps } from "../../../../common/src/template/types.js";
 ...
 */
export declare const readTemplateModules: (feature: string, manifest: Manifest, projectStructure: ProjectStructure) => Promise<TemplateModuleInternal<any, any> | undefined>;
 ...
 */
export declare const generateTemplateResponses: (templateModuleInternal: TemplateModuleInternal<any, any>, templateProps: TemplateProps, pluginRenderTemplates: PluginRenderTemplates, manifest: Manifest, projectStructure: ProjectStructure) => Promise<GeneratedPage>;
