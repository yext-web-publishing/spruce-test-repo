 ...
 */
export declare const createTemplatesJson: (templateFilepaths: string[], redirectFilepaths: string[], projectStructure: ProjectStructure, type: "FEATURES" | "TEMPLATES") => Promise<void>;
/**
 * Generates a templates.json or features.json from the templates.
 */
export declare const createTemplatesJsonFromModule: (templateModules: TemplateModuleCollection, redirectModules: RedirectModuleCollection, projectStructure: ProjectStructure, type: "FEATURES" | "TEMPLATES") => Promise<void>;
export declare const getTemplatesConfig: (templateModules: TemplateModuleCollection, redirectModules?: RedirectModuleCollection) => FeaturesConfig;
/**
