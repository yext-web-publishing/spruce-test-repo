 ...
 * query param.
 */
export declare const findStaticTemplateModuleAndDocBySlug: (devserver: ViteDevServer, templateFilepaths: string[], useProdUrls: boolean, slug: string, locale?: string) => Promise<StaticTemplateAndProps | void>;
