 ...
 */
export declare const generateTestData: (scope?: string) => Promise<unknown>;
export declare const generateTestDataForSlug: (stdout: NodeJS.WriteStream, vite: ViteDevServer, slug: string, projectStructure: ProjectStructure) => Promise<any>;
