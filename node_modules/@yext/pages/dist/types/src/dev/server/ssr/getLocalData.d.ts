...
export declare const readLocalDataFile: (localDataFilepath: string) => Promise<Record<string, any> | undefined>;
 ...
 */
export declare const getLocalData: (criterion: (data: any) => boolean) => Promise<LocalData | undefined>;
/**
 * Reads through all localData and returns all documents that match criterion.
 */
export declare const getAllLocalData: (criterion: (data: any) => boolean) => Promise<LocalData[]>;
/**
