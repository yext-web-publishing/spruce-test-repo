...
export declare class ProjectStructure {
    ...
    static init: (projectStructureConfig?: Optional<ProjectStructureConfig>) => Promise<ProjectStructure>;
    /**
     ...
     */
    getModulePaths: (moduleName?: string) => Path[];
}
