import { TemplateModuleInternal } from "../internal/types.js";
 ...
 */
export declare const loadTemplateModules: (templateModulePaths: string[], transpile: boolean, adjustForFingerprintedAsset: boolean, projectStructure: ProjectStructure) => Promise<TemplateModuleCollection>;
 ...
 */
export declare const loadTemplateModuleCollectionUsingVite: (vite: ViteDevServer, templateFilepaths: string[]) => Promise<TemplateModuleCollection>;
