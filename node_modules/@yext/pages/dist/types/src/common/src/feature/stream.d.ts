 ...
 */
export declare const convertTemplateConfigToStreamConfig: (config: TemplateConfigInternal | undefined) => StreamConfig | void;
/**
 * Converts a {@link RedirectConfig.config.stream} into a valid {@link StreamConfig}.
 */
export declare const convertRedirectConfigToStreamConfig: (config: RedirectConfigInternal | undefined) => StreamConfig | void;
