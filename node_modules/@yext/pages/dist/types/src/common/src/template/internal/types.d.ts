import { Template, GetHeadConfig, GetPath, GetRedirects, TransformProps, Render, TemplateConfig, TemplateModule, TemplateProps, TemplateRenderProps } from "../types.js";
/**
