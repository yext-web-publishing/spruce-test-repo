import { Template, GetHeadConfig, GetPath, GetRedirects, TransformProps, Render, Stream, TemplateConfig, TemplateModule, TemplateProps, TemplateRenderProps, GetAuthScope } from "../types.js";
/**
 ...
 */
export declare const parse: (filepath: string, adjustForFingerprintedAsset: boolean) => {
    base: string;
    name: string;
};
export declare const isStaticTemplateConfig: (streamId: string | undefined, streamConfig: StreamInternal | undefined) => boolean;
...
export declare const convertTemplateConfigToTemplateConfigInternal: (templateName: string, templateConfig: TemplateConfig | undefined) => TemplateConfigInternal;
/**
 ...
 */
export declare const convertStreamToStreamInternal: (stream: Stream | undefined) => StreamInternal | undefined;
