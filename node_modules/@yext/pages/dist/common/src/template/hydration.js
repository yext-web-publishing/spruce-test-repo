...
const getCommonInjectedIndexHtml = (clientHydrationString, indexHtml, appLanguage, headConfig) => {
...
const getIndexTemplateDev = (clientHydrationString, indexHtml, appLanguage, headConfig) => {
