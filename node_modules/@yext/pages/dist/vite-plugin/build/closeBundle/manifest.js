...
const generateManifestFile = async (templateModules, redirectModules, projectStructure) => {
  ...
  const featureNameToRedirectPath = /* @__PURE__ */ new Map();
  ...
  const redirectBundlePaths = Array.from(
    ...
    name,
    convertToPosixPath(distPath.getRelativePath(path2))
  ]);
