...
// reserve privileged copies of required global JS functionality for platform
// code to use in unprivileged contexts
export const privilegedPostMessage: any = globalThis.postMessage;
